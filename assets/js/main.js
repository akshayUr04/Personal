...
function validate() {
  ...
  if (name.length == 0) {
    ...
    nameError.innerText = 'Write a FullName';
    nameError.style.color = 'red'
    flag = 2
  }

  else if (name.match(spc)) {
    nameError.innerText = 'first character cannot be special character ';
    nameError.style.color = 'red'
    flag = 2
  }
  ...
  if (message.length == 0) {
    messageError.innerText = 'subject is Required';
